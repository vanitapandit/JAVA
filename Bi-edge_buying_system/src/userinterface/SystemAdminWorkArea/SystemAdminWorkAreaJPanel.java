...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public SystemAdminWorkAreaJPanel(JPanel userProcessContainer, BiedgeBuyingSystem system) {
        initComponents();
    ...
    public void populateTree(){
        ...
        for(Map.Entry<String, Network> network : networkMap.entrySet()){
            ...
            networkNode=new DefaultMutableTreeNode(network.getKey());
            ...
            for(Map.Entry<String, Enterprise> enterprise : enterpriseMap.entrySet()){
                ...
                enterpriseNode=new DefaultMutableTreeNode(enterprise.getKey());
